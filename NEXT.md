...
3. ~~CHAPTER 1~~ — **shipped** (v1.4). ~~CHAPTER 2~~ — **shipped** (v1.6).
   ~~CHAPTER 3~~ — **shipped** (v1.8, "NextNext"). Next gate: **Chapter 4 —
   THE HUNT** (the grey beast at the black pools; the ring, the rank-up
   2/2/2, the craft seated, Netherlight, the ring AGING from 120), at the
   author's word.
