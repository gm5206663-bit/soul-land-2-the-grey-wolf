...
- Word count (body): 2,528 (measure_prose; working band 2,400–3,400 — in band). Spoken dialogue: 18 lines (7.1 per 1000w). Metrics: average 16.8w, median 13w, longest 51w; no prose sentence over 60w; the-way construction: zero (idioms excepted).
