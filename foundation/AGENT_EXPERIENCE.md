...
- **F16** Thousand-year gate: by Ch5, Ghost 120y yellow within limits, Stormwind 603y yellow within limits, Level 29-30, everything Mid+, Grey Ridge Hunt fusion of basics — footwork fusion already: Walking+Running+Mountain Stride → Silent Wind Step Mid ONE.
- **F17** Evolution: Grey Wolf → Ice Wolf → Frost Ghost Wolf → Storm Frost Ghost Wolf when Grey 65% High + both rings purple. Skill upgrade on color break: Light of Netherworld Low → Netherlight Mid → Ghost Veil High → Ghost Storm Veil Top different name, Wind Blade Burst Low → Windstride Mid → Storm Step High different name. Ring Veil Low → Veil of Ghost High → Phantom Veil Top yellow within limits — PROPOSED dimming not canon. Fool shows two thousand-year rings.
- **F18 Full Status:** all 15 life-skills evolving Low→Mid→High with different name per grade and correct evolution per technique, not everything into Silent Wind Step, footwork fusion mandatory. Martial soul ice+wind, body 100-150kg robust for age lift robust, named technique like Purple Demon Eyes 4 stages but evolution chain with different name, Spirit Connection 200-300, wind attribute even, STATUS.md must have everything.
...
- Key facts learned:
  ...
  - Purple Demon Eyes: 4 stages Perception/Attention/Intoxication/Immersion, training purple qi morning, effects vision + confuse/stun + mind's eye 10-20m — different name per stage, evolution chain with different name per grade.
  - Body thousand-year: 10y ring +10, 100y +100, 1000y +1000. Pool deepened, pathways widened, vitality. Beast bodies robust even without release. 100-150kg lift at 11.
...
- Body: 100-150kg lift, robust beast-type, denser bone, quicker muscle, predator frame, amber ice-amber eyes, grey tint hair, height shoulders, cold tolerance, recovery, appearance freight, dogs ignore, wood passes at peace
- Spiritual Realm: Spirit Connection 200-300, vast as sea, perception 10-20m, house fly detail
...
- Rings: Ghost 120y yellow within limits (concealed 120y yellow), Stormwind 603y yellow within limits (concealed 603y yellow) via Veil of Ghost High
...
- Body 100-150kg robust — 2 thousand-year rings give 2000 attribute increase + Grey body-line
- Spirit Connection 200-300 — perception 10-20m, battleship pilot foundation
