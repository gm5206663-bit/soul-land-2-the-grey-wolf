...
v1.0, 2026-09-25. THE STATUS PANEL LAW: the full panel exists from
chapter one, night one, and this file is updated the same turn any number
moves. The drift guard enforces the panel lines against `PANELS.md`; this
...
- **One technique seat, and his choice already made in it:** the standard
  ...
  cultivated an hour in this body. The hunter's craft his father taught
...
- **The life-skills at their honest levels:** a hunter's son's legs and
  ...
  knew. No Reading line — he cannot read this world's script yet. The
  line will surface when the skill does.
